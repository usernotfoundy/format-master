...
class DatabaseService {
  ...
  Future<List<Lesson>> getAllLessons() async {
    if (kIsWeb) {
      ...
      lessons.sort((a, b) => (a['order'] as int).compareTo(b['order'] as int));
